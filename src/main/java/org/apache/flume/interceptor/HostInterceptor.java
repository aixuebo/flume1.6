...
public class HostInterceptor implements Interceptor {
  ...
  private final String header;//header中的key
  private String host = null;//发送请求那台服务器的ip或者host全信息
   ...
   * 向header中添加本地ip信息,但是如果preserveExisting为true,header中又存在ip信息,则不做任何处理
   */
  @Override
