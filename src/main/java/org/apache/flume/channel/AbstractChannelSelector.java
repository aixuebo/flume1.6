...
/**
 * 一个name把一群Channel给做了分组,即该name代表一群channel
 */
public abstract class AbstractChannelSelector implements ChannelSelector {
  ...
  /**
   * 给定参数channels是按照空格进行拆分的一组channel集合
   * 从channelNameMap中以此获取channels集合中每一个channe Name对应的channel对象返回
