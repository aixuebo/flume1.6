...
public class Serialization {
  ...
  static final long SIZE_OF_INT = 4;//一个int占用空间
  static final int SIZE_OF_LONG = 8;//一个long占用空间


  static final int VERSION_2 = 2;
  static final int VERSION_3 = 3;

  public static final String METADATA_FILENAME = ".meta";//meta最终文件
  public static final String METADATA_TMP_FILENAME = ".tmp";//meta临时文件
   ...
   * 删除checkpointDir下面的所有子文件数据,不删除的可以存储到excludes集合中,excludes存储文件名即可,不需要全路径
   */
