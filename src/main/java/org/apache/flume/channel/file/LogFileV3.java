...
public class LogFileV3 extends LogFile {
  ...
  static class MetaDataWriter extends LogFile.MetaDataWriter {
    ...
    //重新生成meta文件,更新该文件的CheckpointPosition、CheckpointWriteOrderID为现在事实的内容
    //将上一个版本的meta文件的CheckpointPosition、CheckpointWriteOrderID设置到新meta文件中的BackupCheckpointPosition、BackupCheckpointWriteOrderID
    @Override
